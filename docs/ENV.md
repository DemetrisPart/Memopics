...
| `STORAGE_BUCKET` | Phase 3+ | Bucket name | `momeva` |
...
|---|---|---|
| `ACCESS_TOKEN_COOKIE` | `momeva_access` | HTTP-only access cookie name |
| `REFRESH_TOKEN_COOKIE` | `momeva_refresh` | HTTP-only refresh cookie name |
| `GUEST_SESSION_COOKIE` | `momeva_guest` | Guest session cookie name |
